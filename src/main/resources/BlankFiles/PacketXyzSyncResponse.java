...
public class PacketXyzSyncResponse extends PacketAbstractSyncResponse {

    public PacketXyzSyncResponse(int energy, boolean shouldClose) {
        super(energy, shouldClose);
    }

    public PacketXyzSyncResponse(PacketBuffer buf) {
        super(buf);
    }
